...
UNIQUE_USER_IDS = [2, 3, 4]
UNIQUE_USER_HASHES = [b'1323222', b'223222', b'4333322']
USER_IDS_USED_FOR_VOTES = [1, 1, 2, 2, 3, 3]
USER_IDS_USED_FOR_VOTES_VOTED_CANDIDATE = [1, 2, 3, 3, 1, 2]
USER_IDS_USED_FOR_VOTES_POINTS = [10, 1, 2, 7, 1, 9]
UNIQUE_CANDIDATE_IDS = [1, 2]
UNIQUE_CANDIDATE_NAMES = [b'Matyas', b'Miguel']
VOTING_NAME = b'Matyasfirstvote'
...
for index in range(0, number_of_existing_votings):
    ...
    voter_id = 1
    voted_candidate_ids = voting_results.functions.getVotedCandidateIdsForVoterIdForVoting(voter_id, b'Matyasfirstvote').call()
    print("voted candidate ids for voter with id {} and voting name {}: {}".format(voter_id, b'Matyasfirstvote', voted_candidate_ids))
    voted_candidate_points = voting_results.functions.getVotedCandidatePointsForVoterIdForVoting(voter_id, b'Matyasfirstvote').call()
    print("voted candidate points for voter with id {} and voting name {}: {}".format(voter_id, b'Matyasfirstvote', voted_candidate_points))
    candidate_id = 2
    candidate_name = voting_results.functions.getCandidateNameForCandidateIdForVoting(
        candidate_id, b'Matyasfirstvote').call()
    ...
    voter_id_found_through_hash = voting_results.functions.getVoterIdForVoterHashForVoting(
        voter_hash, b'Matyasfirstvote').call()
